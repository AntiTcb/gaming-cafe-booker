/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 38df28eabbd6bb59bbfe1c3ae0b03c05)
// Runtime types generated with workerd@1.20250917.0 2025-09-09 nodejs_als,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../.svelte-kit/cloudflare/_worker");
	}
	interface Env {
		PUBLIC_TRUSTED_ORIGINS: "https://booker.antitcb.dev" | "https://staging-booker.antitcb.dev";
		PUBLIC_SITE_DOMAIN: string;
		PUBILC_TRUSTED_ORIGINS: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_TRUSTED_ORIGINS" | "PUBLIC_SITE_DOMAIN" | "PUBILC_TRUSTED_ORIGINS" | "PUBLIC_BETTER_AUTH_URL" | "MAILGUN_DOMAIN" | "DATABASE_URL" | "BETTER_AUTH_SECRET" | "MAILGUN_API_KEY">> {}
}
